...
class DQN:
    ...
    def build_model(self):
        ...
        #Layers with the same name as in the CartPole model will get the transferred weights
        model = Sequential()
        model.add(Dense(150, input_dim=self.state_space, activation=relu, name='newDense1'))
        model.add(Dense(120, activation='relu', name='dense_2'))
        #model.add(Dense(120, activation='relu', name='dense_3'))
        model.add(Dense(self.action_space, activation=linear, name='newDense3'))
        model.load_weights('/Users/lineelgaard/Documents/Data Science/ExamProject - DQN Transfer Learning/modelCartPole.h5', by_name=True)
...
def train_dqn(episode):
    ...
    savetxt('lossTransfer_CPtoLL_6_2.csv', data, delimiter=',')
