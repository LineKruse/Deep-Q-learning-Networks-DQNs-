...
def train_dqn(episode):
    ...
    os.chdir('/Dropbox/ExamProject - DQN Transfer Learning/')
    data = np.column_stack((loss, episodes))
    savetxt('lossLunarLander_7_8.csv', data, delimiter=',')
...
def random_policy(episode, step):
    ...
    data = np.column_stack((loss, episodes))
    savetxt('lossLunarLander_7_1.csv', data, delimiter=',')
...
if __name__ == '__main__':
    ...
    #loss = random_policy(episodes, 1000)
